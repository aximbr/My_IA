...
# Lesson 5.01, 5.02, 5.03
# Objective: load dataset from sklearn and Multivariate regression
"""
...
# Since sklearn do not provide this dataset, is necessary use fetch
...
boston_array = np.array(boston_dataset.data)
print(boston_array.shape)
